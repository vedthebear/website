    ...
    <main className="flex-1 flex flex-col items-center px-8 py-16">
      <div className="w-full max-w-4xl flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-5 text-xl leading-relaxed text-black">
          ...
          <p>
            I spend most of my time these days <a href="https://github.com/vedthebear/" target="_blank" rel="noopener noreferrer" className="text-link">tinkering with Claude Code</a>, reading papers, running experiments, and <Link href="/writing" className="text-link">writing</Link> about what I'm learning. Outside of that, I read a lot and play sports. I was previously a top 5 badminton player in the USA.
          </p>
          <p>I love learning.</p>
